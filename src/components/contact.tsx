...
export const Contact = () => {
  return (
    <footer id="contact" className="pt-20 pb-10 bg-gray-900 text-white">
      <div className="container px-6 mx-auto text-center">
        <h2 className="text-3xl font-bold mb-8">Get In Touch</h2>
        <p className="max-w-xl mx-auto text-gray-400 mb-12">
          I&apos;m currently looking for research opportunities and scholarships
          for higher studies. If you have any questions or just want to say hi,
