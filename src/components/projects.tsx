            ...
            return (
              ...
              >
                <MagneticCard>
                  ...
                  >
                    <div
                      className={`group h-full flex flex-col bg-paper dark:bg-ink-faint border border-ink-rule hover:border-oxide transition-all duration-300 ${
                        isHighlighted
                          ? "ring-2 ring-oxide/50 shadow-[0_0_30px_rgba(178,58,72,0.15)]"
                          : ""
                      }`}
                    >
